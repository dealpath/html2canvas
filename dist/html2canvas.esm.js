...
var hsl = function (context, args) {
    ...
    var h = (hue.type === 17 /* TokenType.NUMBER_TOKEN */ ? deg(hue.number) : angle.parse(context, hue)) / (Math.PI * 2);
...
var DocumentCloner = /** @class */ (function () {
    function DocumentCloner(context, elements, options) {
        this.context = context;
        ...
        this.documentElement = this.cloneNode(elements[0].ownerDocument.documentElement, false);
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        referenceElements = this.clonedReferenceElements;
                        if (typeof referenceElements === 'undefined') {
                            return [2 /*return*/, Promise.reject("Error finding the ".concat(this.referenceElements[0].nodeName, " in the cloned document"))];
                        }
                    ...
                    case 4:
                        if (typeof onclone === 'function') {
                            return [2 /*return*/, Promise.resolve()
                                    .then(function () { return onclone(documentClone, referenceElements); })
    ...
    DocumentCloner.prototype.cloneNode = function (node, copyStyles) {
        ...
        if (window && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
            ...
            if (this.referenceElements.includes(node) && isHTMLElementNode(clone)) {
...
var html2canvas = function (elements, options) {
    if (options === void 0) { options = {}; }
    return renderElement(elements, options);
};
if (typeof window !== 'undefined') {
    CacheStorage.setContext(window);
}
var renderElement = function (elements, opts) { return __awaiter(void 0, void 0, void 0, function () {
    var ownerDocument, defaultView, resourceOptions, contextOptions, windowOptions, windowBounds, context, foreignObjectRendering, cloneOptions, documentCloner, clonedElements, canvases, _i, clonedElements_1, clonedElement, container, _a, width, height, left, top_1, backgroundColor, renderOptions, canvas, renderer, root, renderer;
    var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t;
    return __generator(this, function (_u) {
        switch (_u.label) {
            case 0:
                if (!elements || typeof elements[0] !== 'object') {
                    return [2 /*return*/, Promise.reject('Invalid element provided as first argument')];
                }
                ownerDocument = elements[0].ownerDocument;
                if (!ownerDocument) {
                ...
                documentCloner = new DocumentCloner(context, elements, cloneOptions);
                clonedElements = documentCloner.clonedReferenceElements;
                if (!clonedElements) {
                    return [2 /*return*/, Promise.reject("Unable to find element in cloned iframe")];
                }
                canvases = [];
                _i = 0, clonedElements_1 = clonedElements;
                _u.label = 1;
            case 1:
                if (!(_i < clonedElements_1.length)) return [3 /*break*/, 8];
                clonedElement = clonedElements_1[_i];
                return [4 /*yield*/, documentCloner.toIFrame(ownerDocument, windowBounds)];
            case 2:
                container = _u.sent();
                _a = isBodyElement(clonedElement) || isHTMLElement(clonedElement)
                    ? parseDocumentSize(clonedElement.ownerDocument)
                    : parseBounds(context, clonedElement), width = _a.width, height = _a.height, left = _a.left, top_1 = _a.top;
                ...
                renderOptions = {
                    ...
                    y: ((_q = opts.y) !== null && _q !== void 0 ? _q : 0) + top_1,
                    width: (_r = opts.width) !== null && _r !== void 0 ? _r : Math.ceil(width),
                    height: (_s = opts.height) !== null && _s !== void 0 ? _s : Math.ceil(height)
                };
                canvas = void 0;
                if (!foreignObjectRendering) return [3 /*break*/, 4];
            ...
            case 3:
                ...
                return [3 /*break*/, 6];
            case 4:
                context.logger.debug("Document cloned, element located at ".concat(left, ",").concat(top_1, " with size ").concat(width, "x").concat(height, " using computed rendering"));
            ...
            case 7:
                _i++;
                return [3 /*break*/, 1];
            case 8: return [2 /*return*/, canvases];
        }
    });
}); };
